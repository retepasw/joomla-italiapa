...
( function( $ ) {
	$( document ).ready( function( ) {
		...
		const copyright = '<style>' +
			...
			'.ipa-copyright a{text-decoration:none;font-weight:bold}' +
			'.ipa-copyright img{vertical-align:bottom}' +
			'@media screen and (min-width:768px){.ipa-copyright>a:nth-of-type(1){float:left}}' +
		...
		if ($('footer').length == 0) {
			$('body').append('<footer class="Footer u-padding-all-s u-background-95 u-hiddenPrint" id="footer">' + copyright + '</footer>')
		} else {
