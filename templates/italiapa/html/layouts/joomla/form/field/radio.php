...
$class = "Form-field Form-field--choose Grid-cell";
?>
	...
	<?php if (!empty($options)) : ?>
		<?php foreach ($options as $i => $option) : ?>
			<?php
				...
				$option->class  = trim('Form-input ' . $option->class . ' ' . $disabled);
			...
			<?php endif; ?>
			<label for="<?php echo $oid; ?>" <?php echo trim('class="Form-label Form-label--block" ' . $style); ?>>
