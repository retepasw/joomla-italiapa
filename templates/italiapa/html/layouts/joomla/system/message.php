	...
	<?php if (is_array($msgList) && !empty($msgList)) : ?>
		<div id="system-message">
			<?php foreach ($msgList as $type => $msgs) : ?>
				...
				<div class="Prose Alert Alert--<?php echo $type; ?> Alert--withIcon u-layout-prose u-padding-r-bottom u-padding-r-right u-margin-r-bottom" role="alert">
					...
					<p class="u-text-p"><?php echo $msg; ?></p>
					<?php endforeach; ?>
					<?php endif; ?>
				</div>
			<?php endforeach; ?>
