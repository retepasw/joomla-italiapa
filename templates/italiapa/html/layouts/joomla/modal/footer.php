...
<?php if (isset($params['footer']) && $params['footer']) : ?>
	<?php echo $params['footer']; ?>
<?php endif; ?>

<?php if (!isset($params['closeButton']) || $params['closeButton']) : ?>
	<button class="Button Button--danger js-fr-dialogmodal-close u-floatRight"><?php echo JText::_('JLIB_HTML_BEHAVIOR_CLOSE'); ?></button>
<?php endif; ?>
