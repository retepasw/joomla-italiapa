...
<?php if ($displayData['params']->get('link_category') && $displayData['item']->catslug) : ?>
	...
	<a class="u-textClean u-text-r-xs" href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($displayData['item']->catslug)); ?>" itemprop="genre"><?php echo $title; ?></a></span>
<?php else : ?>
