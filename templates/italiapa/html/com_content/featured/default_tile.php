...
<div class="Grid u-color-grey-30 u-border-top-xxs u-padding-right-xxl u-padding-r-all">
	...
	<?php elseif ($images->image_intro && $imgfloat == 'none') : ?>
		<div class="Grid-cell u-sizeFull">
			<?php echo JLayoutHelper::render('joomla.content.intro_image', $this->item); ?>
		</div>
	<?php endif; ?>

	<div class="Grid-cell u-sizeFull<?php echo ($images->image_intro && $imgfloat != 'none' ? ' u-md-size2of3 u-lg-size2of3' : ''); ?> u-text-r-s u-padding-r-all">
	...
	<?php if ($images->image_intro && $imgfloat == 'right') : ?>
		<div class="Grid-cell u-sizeFull u-md-size1of3 u-lg-size1of3 u-text-r-s u-padding-r-all">
			<?php echo JLayoutHelper::render('joomla.content.intro_image', $this->item); ?>
		</div>
	<?php endif; ?>
