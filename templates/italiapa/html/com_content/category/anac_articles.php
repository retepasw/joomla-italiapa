...
<table class="Table Table--striped Table--hover Table--withBorder">
	...
	<thead>
		...
		<?php endif; ?>
		<th scope="col" id="categorylist_download" class="u-textCenter">
			<?php echo JText::_('TPL_ITALIAPA_HEADING_DOWNLOAD'); ?>
		</th>
	...
	<tbody>
		<?php foreach ($this->items as $i => $article) : ?>
			...
			<?php endif; ?>
			<td class="list-download">
				<?php if (!empty($article->urls)) : ?>
					<?php $urls = json_decode($article->urls); ?>
					<?php if (!empty($urls->urla)) : ?>
						<a href="<?php echo $urls->urla; ?>" itemprop="url" download target="_blank">
