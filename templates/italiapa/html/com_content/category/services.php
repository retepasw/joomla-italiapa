...
<section class="Grid <?php echo $this->pageclass_sfx ?: 'services'; ?>" itemscope itemtype="https://schema.org/Blog">
	<div class="Grid-cell u-sizeFull u-layout-wide u-layoutCenter">
		<?php if ($this->params->get('show_description_image') && $this->category->getParams()->get('image')) : ?>
			...
			<?php $size = "u-sizeFull u-md-size1of2 u-lg-size1of2"; ?>			
		<?php else : ?>
			<?php $size = "u-sizeFull"; ?>
		<?php endif; ?>
		<div class="Grid-cell <?php echo $size; ?> u-text-r-s u-padding-r-all">
			<div class="u-text-p">
				...
				<?php if ($beforeDisplayContent || $afterDisplayContent || $this->params->get('show_description', 1) || $this->params->def('show_description_image', 1)) : ?>
					<div class="category-desc clearfix Prose u-layout-prose">
	...
	<div class="Grid-cell u-sizeFull u-padding-r-all">
		<div class="Grid u-layout-wide u-layoutCenter">
			...
			<?php $innerRightModules = array(); ?>
			<?php foreach (JModuleHelper::getModules('inner-right') AS $module) : ?>
				<?php $innerRightModules[] = JModuleHelper::renderModule($module, array('style'=>'lg')); ?>
			<?php endforeach; ?>

			<?php if (count($innerRightModules)) : ?>
			<div class="Grid-cell u-sizeFull u-md-size8of12 u-lg-size8of12">
			<?php endif; ?>
			<div class="u-layout-centerContent u-padding-r-top">

				<?php foreach (JModuleHelper::getModules('inner-top') AS $module) : ?>
					<?php echo JModuleHelper::renderModule($module, array('style'=>'lg')); ?>
				<?php endforeach; ?>

				<section class="u-text-r-s u-padding-r-top u-padding-r-bottom <?php echo $this->pageclass_sfx; ?>" itemscope itemtype="https://schema.org/Blog">
					...
					<div class="Prose Alert Alert--info">
						<p><?php echo JText::sprintf('TPL_ITALIAPA_SEARCH_SORT_' . strtoupper($this->params->get('orderby_sec')), count($this->items), 'servizi'); ?></p>
					</div>
					...
					<div class="Grid Grid--withGutterM">
						...
						<?php foreach(array_merge($this->lead_items, $this->intro_items) as $item) : ?>
							...
							<div class="Grid-cell u-md-size1of<?php echo (int) $this->columns; ?> u-lg-size1of<?php echo (int) $this->columns; ?> u-flex u-margin-r-bottom u-flexJustifyCenter
								<?php echo $item->state == 0 ? ' system-unpublished' : null; ?>" itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
								<?php $this->item = &$item; ?>
			...
			<?php if (count($innerRightModules)) : ?>
				...
				<div class="Grid-cell u-sizeFull u-md-size4of12 u-lg-size4of12 u-padding-left-<?php echo (count(JModuleHelper::getModules('right')) ? 'xs' : 'm'); ?>">
					<?php foreach ($innerRightModules AS $module) : ?>
						<?php echo $module; ?>
					<?php endforeach; ?>
				</div>
			<?php endif; ?>
