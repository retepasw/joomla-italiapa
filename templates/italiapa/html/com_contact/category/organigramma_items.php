...
<?php Table::addIncludePath(JPATH_ADMINISTRATOR . '/components/com_contact/tables'); ?>
<?php $contact = Table::getInstance('contact', 'ContactTable'); ?>
	...
	<?php if (in_array($item->access, $this->user->getAuthorisedViewLevels())) : ?>
		<div class="u-sizeFull">
			...
			<div class="u-cf u-margin-bottom-s">
				...
				<?php if ($item->con_position && (true || $mparams->get('show_position_headings'))) : ?>
					<div class="contact-position u-text-h5">
						...
						<?php if ((int) $item->user_id) : ?> 
							<?php $user = JFactory::getUser($item->user_id); ?>
							: <?php echo $user->name; ?>
				...
				<?php if (true || $tparams->get('show_links')) : ?>
