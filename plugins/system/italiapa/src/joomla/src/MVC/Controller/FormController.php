...
// Make alias of original FormController
\Italiapa\Helper\Joomla::makeAlias(JPATH_LIBRARIES . '/src/MVC/Controller/FormController.php', 'FormController', '_JControllerForm');
 ...
 */
class FormController extends _JControllerForm 
{
	/**
